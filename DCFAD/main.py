...
if __name__ == '__main__':
    ...
    parser.add_argument('--c_list', type=parse_int_list, default=fileconfig['train']['c_list'])
    ...
    parser.add_argument('--f_tr', type=float, default=fileconfig['data']['f_tr'])
    parser.add_argument('--dr', type=float, default=fileconfig['data']['dr'])
